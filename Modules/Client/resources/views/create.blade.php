<x-app-layout>
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        <form action="{{ route('clients.store') }}" method="POST">
            ...
            <div class="mb-4">
                <label for="client_email" class="block text-sm font-medium text-gray-700 dark:text-gray-800">Client Email</label>
            ...
            <div class="mb-4">
                <label for="contact_person_name" class="block text-sm font-medium text-gray-700 dark:text-gray-800">Contact person</label>
            ...
            <div class="mb-4">
                <label for="contact_person_phone" class="block text-sm font-medium text-gray-700 dark:text-gray-800">Contact person phone</label>
            ...
            <div class="mb-4">
                <label for="billing_cycle_in_years" class="block text-sm font-medium text-gray-700 dark:text-gray-800">Billing Cycle</label>
            ...
            <div class="mb-4">
                <label for="streamline_engineer_name" class="block text-sm font-medium text-gray-700 dark:text-gray-800">Streamline engineer</label>
            ...
            <div class="mb-4">
                <label for="streamline_engineer_phone" class="block text-sm font-medium text-gray-700 dark:text-gray-800">Streamline Engineer phone</label>
            ...
            <div class="mb-4">
                <label for="streamline_engineer_email" class="block text-sm font-medium text-gray-700 dark:text-gray-800">Streamline Engineer Email</label>
