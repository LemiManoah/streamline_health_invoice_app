<x-app-layout>
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        <form action="{{ route('clients.update', $client->id) }}" method="POST">
            ...
            <div class="mb-4">
                <label for="billing_cycle_in_years" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Billing cycle</label>
                <input type="number" id="billing_cycle_in_years" name="billing_cycle_in_years" value="{{ old('billing_cycle_in_years', $client->billing_cycle) }}" 
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" 
                    required>
