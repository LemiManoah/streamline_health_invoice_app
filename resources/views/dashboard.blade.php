    ...
    <div class="mt-4">
        <div class="flex flex-wrap -mx-6">
            @foreach ($dashboardData as $data)
                <div class="w-full px-6 sm:w-1/2 xl:w-1/3 @if (!$loop->first) mt-6 sm:mt-0 @endif">
                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                        <div class="p-3 rounded-full {{ $data['color'] }} bg-opacity-75">
                            @if($data['icon'] == 'clients')
                            ...
                            @elseif($data['icon'] == 'notifications')
                        ...
                        <div class="mx-5">
                            <h4 class="text-2xl font-semibold text-gray-700">{{ $data['count'] }}</h4>
                            <div class="text-gray-500">{{ $data['label'] }}</div>
                        </div>
                    </div>
                </div>
            @endforeach
